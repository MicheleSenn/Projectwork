...
ggplot() +
  ...
  labs(title="Caroline's distance to Schreck 5 / 6 around inField time. Red points mean: in the bean field", colour="")
...
ggplot() +
  ...
  labs(title="Caroline's distance to Schreck 5 and 6", colour="Location")
