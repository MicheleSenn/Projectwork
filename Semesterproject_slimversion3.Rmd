...
Sabine seems to be spending 0 % of her time in that field before the Schreck was put there, 0.9 % of her time during the Schrecks active period and 0.4 % of her time after the Schrecks active period.
...
```{r plot beforeduringafter in field}
...
beforeduringafter <- data.frame(before = c ("Caroline"= 0.03, "Sabine"= 0, "Olga"= 0.4), during = c(2, 0.9, 2), after = c(0.4, 0.4, 0.7))
