...
To conceptualize the active and inactive time of the Schreck, a background fill was used. Subsequently, it was tested if complexity could be reduced by reduction of sampling size
...
Olga's and Sabine's data were prepared following the same steps as was done with Caroline (preparation steps not shown).
