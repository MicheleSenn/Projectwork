...
ggarrange(
  ...
  geom_point(data=inter_sel_5_6_long_shorter,aes(as.Date(DatetimeUTC),inField, colour="In bean field")) +
  labs(subtitle= "Reducing sample size to every 50th observation", colour="Location") +
  ...
  geom_line(data=Caroline_Schreck5_6_withField_long_aroundInFieldtime_smooth,aes(as.Date(DatetimeUTC),distance5_6)) +
  geom_point(data=inter_sel_5_6_long_shorter,aes(as.Date(DatetimeUTC),inField, colour="In bean field")) +
  labs(subtitle= "Reducing sample size to every 150th observation", colour="Location") +
    rremove("y.title") + rremove("x.title"),
...
ggplot() +
  ...
  labs(title="Olga's distance to Schreck 5 and 6", colour="Location")
...
ggplot() +
  ...
  labs(title="Sabine's distance to Schreck 5 and 6", colour="Location")
