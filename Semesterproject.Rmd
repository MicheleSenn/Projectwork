...
ggplot() + geom_sf(data=wildschwein_schreck1_close, aes(color=TierName)) + coord_sf(datum=2056)

ggplot(wildschwein_schreck1_close, aes(DatetimeUTC,distance, color=TierName)) + geom_point()
```
