...
```{r Schreck 5 is in a bean field}
...
#das ist unser Feld, in welches z.B. Caroline immer wieder zurückkehrt
...
inter_sel_5_long <- distance5_Caroline_longerThanSchrecktime[intersection_195andSchreck5[[1]],]
